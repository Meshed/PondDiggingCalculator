...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Types$Messages$ConfigLoaded = function(a) {
        return {
            $: 'ConfigLoaded',
            a: a
        };
    };
    var $author$project$Types$DeviceType$Desktop = {
        $: 'Desktop'
    };
    var $author$project$Types$Messages$DeviceDetected = function(a) {
        return {
            $: 'DeviceDetected',
            a: a
        };
    ...
    var $author$project$Utils$DeviceDetector$detectDevice = function(_v0) {
        return A2($elm$core$Task$attempt, $elm$core$Basics$identity, A2($elm$core$Task$map, function(viewport) {
            return {
    ...
    var $author$project$Utils$Debounce$defaultDelay = 300.0;
    var $author$project$Utils$Debounce$initDebounce = {
        delay: $author$project$Utils$Debounce$defaultDelay,
        lastInputTime: 0.0
    };
    var $author$project$Utils$Performance$performanceThreshold = 100.0;
    var $author$project$Utils$Performance$initMetrics = {
        averageTime: 0.0,
        calculationCount: 0,
        lastCalculationTime: 0.0,
        maxTime: 0.0,
        warningThreshold: $author$project$Utils$Performance$performanceThreshold
    };
    var $author$project$Utils$Config$Config = F3(function(version, defaults, validation) {
        return {
            defaults: defaults,
    ...
    var $author$project$Utils$Config$Defaults = F3(function(excavator, truck, project) {
        return {
            excavator: excavator,
            project: project,
            truck: truck
    ...
    var $author$project$Utils$Config$ExcavatorDefaults = F3(function(bucketCapacity, cycleTime, name) {
        return {
    ...
    var $author$project$Utils$Config$excavatorDefaultsDecoder = A4($elm$json$Json$Decode$map3, $author$project$Utils$Config$ExcavatorDefaults, A2($elm$json$Json$Decode$field, 'bucketCapacity', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'cycleTime', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
    var $author$project$Utils$Config$ProjectDefaults = F4(function(workHoursPerDay, pondLength, pondWidth, pondDepth) {
        return {
            pondDepth: pondDepth,
    ...
    var $author$project$Utils$Config$projectDefaultsDecoder = A5($elm$json$Json$Decode$map4, $author$project$Utils$Config$ProjectDefaults, A2($elm$json$Json$Decode$field, 'workHoursPerDay', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'pondLength', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'pondWidth', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'pondDepth', $elm$json$Json$Decode$float));
    var $author$project$Utils$Config$TruckDefaults = F3(function(capacity, roundTripTime, name) {
        return {
            capacity: capacity,
            name: name,
    ...
    var $author$project$Utils$Config$truckDefaultsDecoder = A4($elm$json$Json$Decode$map3, $author$project$Utils$Config$TruckDefaults, A2($elm$json$Json$Decode$field, 'capacity', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'roundTripTime', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
    var $author$project$Utils$Config$defaultsDecoder = A4($elm$json$Json$Decode$map3, $author$project$Utils$Config$Defaults, A2($elm$json$Json$Decode$field, 'excavator', $author$project$Utils$Config$excavatorDefaultsDecoder), A2($elm$json$Json$Decode$field, 'truck', $author$project$Utils$Config$truckDefaultsDecoder), A2($elm$json$Json$Decode$field, 'project', $author$project$Utils$Config$projectDefaultsDecoder));
    var $author$project$Utils$Config$ValidationRules = F6(function(excavatorCapacity, cycleTime, truckCapacity, roundTripTime, workHours, pondDimensions) {
        return {
            cycleTime: cycleTime,
    ...
    var $author$project$Utils$Config$ValidationRange = F2(function(min, max) {
        return {
            max: max,
            min: min
        };
    });
    var $author$project$Utils$Config$validationRangeDecoder = A3($elm$json$Json$Decode$map2, $author$project$Utils$Config$ValidationRange, A2($elm$json$Json$Decode$field, 'min', $elm$json$Json$Decode$float), A2($elm$json$Json$Decode$field, 'max', $elm$json$Json$Decode$float));
    var $author$project$Utils$Config$validationRulesDecoder = A7($elm$json$Json$Decode$map6, $author$project$Utils$Config$ValidationRules, A2($elm$json$Json$Decode$field, 'excavatorCapacity', $author$project$Utils$Config$validationRangeDecoder), A2($elm$json$Json$Decode$field, 'cycleTime', $author$project$Utils$Config$validationRangeDecoder), A2($elm$json$Json$Decode$field, 'truckCapacity', $author$project$Utils$Config$validationRangeDecoder), A2($elm$json$Json$Decode$field, 'roundTripTime', $author$project$Utils$Config$validationRangeDecoder), A2($elm$json$Json$Decode$field, 'workHours', $author$project$Utils$Config$validationRangeDecoder), A2($elm$json$Json$Decode$field, 'pondDimensions', $author$project$Utils$Config$validationRangeDecoder));
    var $author$project$Utils$Config$configDecoder = A4($elm$json$Json$Decode$map3, $author$project$Utils$Config$Config, A2($elm$json$Json$Decode$field, 'version', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'defaults', $author$project$Utils$Config$defaultsDecoder), A2($elm$json$Json$Decode$field, 'validation', $author$project$Utils$Config$validationRulesDecoder));
    ...
    var $author$project$Types$Validation$ConfigurationError = function(a) {
        return {
            $: 'ConfigurationError',
            a: a
        };
    };
    var $author$project$Utils$Config$httpErrorToString = function(error) {
        switch(error.$){
            case 'BadUrl':
                var url = error.a;
            ...
            case 'BadStatus':
                var status = error.a;
                return 'HTTP error: ' + $elm$core$String$fromInt(status);
            default:
                var message = error.a;
                return 'Invalid JSON: ' + message;
        }
    };
    var $author$project$Utils$Config$resultToValidationError = function(result) {
        if (result.$ === 'Ok') {
            var config = result.a;
            return $elm$core$Result$Ok(config);
        } else {
            var httpError = result.a;
            return $elm$core$Result$Err($author$project$Types$Validation$ConfigurationError($author$project$Utils$Config$httpErrorToString(httpError)));
        }
    };
    var $author$project$Utils$Config$loadConfig = function(toMsg) {
        return $elm$http$Http$get({
            expect: A2($elm$http$Http$expectJson, A2($elm$core$Basics$composeR, $author$project$Utils$Config$resultToValidationError, toMsg), $author$project$Utils$Config$configDecoder),
            url: '/config.json'
        });
    };
    var $author$project$Main$init = function(_v0) {
        return _Utils_Tuple2({
            ...
            calculationResult: $elm$core$Maybe$Nothing,
            config: $elm$core$Maybe$Nothing,
            debounceState: $author$project$Utils$Debounce$initDebounce,
            deviceType: $author$project$Types$DeviceType$Desktop,
            formData: $elm$core$Maybe$Nothing,
            lastValidResult: $elm$core$Maybe$Nothing,
            message: 'Pond Digging Calculator - Core Calculation Engine',
            performanceMetrics: $author$project$Utils$Performance$initMetrics
        }, $elm$core$Platform$Cmd$batch(_List_fromArray([
            $author$project$Utils$Config$loadConfig($author$project$Types$Messages$ConfigLoaded),
            A2($elm$core$Platform$Cmd$map, $author$project$Types$Messages$DeviceDetected, $author$project$Utils$DeviceDetector$detectDevice(_Utils_Tuple0))
        ])));
    };
    var $author$project$Types$Messages$WindowResized = F2(function(a, b) {
        return {
            $: 'WindowResized',
            a: a,
            b: b
    ...
    var $author$project$Main$subscriptions = function(_v0) {
        return $elm$browser$Browser$Events$onResize($author$project$Types$Messages$WindowResized);
    };
    var $author$project$Types$Messages$CalculateTimeline = {
        $: 'CalculateTimeline'
    };
    var $author$project$Types$Messages$PerformanceTracked = function(a) {
        return {
            $: 'PerformanceTracked',
            a: a
        };
    };
    var $author$project$Main$calculatePondVolume = F3(function(length, width, depth) {
        return length * width * depth / 27.0;
    });
    var $author$project$Utils$Calculations$Balanced = {
        $: 'Balanced'
    };
    var $author$project$Utils$Calculations$ExcavationBottleneck = {
        $: 'ExcavationBottleneck'
    };
    var $author$project$Utils$Calculations$HaulingBottleneck = {
        $: 'HaulingBottleneck'
    };
    var $author$project$Utils$Calculations$High = {
        $: 'High'
    };
    var $author$project$Utils$Calculations$InvalidConfiguration = function(a) {
        return {
            $: 'InvalidConfiguration',
            a: a
        };
    };
    var $author$project$Utils$Calculations$Low = {
        $: 'Low'
    };
    var $author$project$Utils$Calculations$Medium = {
        $: 'Medium'
    };
    var $elm$core$Basics$abs = function(n) {
        return n < 0 ? -n : n;
    };
    var $author$project$Utils$Calculations$excavatorEfficiencyFactor = 0.85;
    var $author$project$Utils$Calculations$calculateExcavatorRate = F2(function(bucketCapacity, cycleTime) {
        var cyclesPerHour = 60.0 / cycleTime;
        var theoreticalRate = cyclesPerHour * bucketCapacity;
        return theoreticalRate * $author$project$Utils$Calculations$excavatorEfficiencyFactor;
    });
    var $author$project$Utils$Calculations$truckEfficiencyFactor = 0.8;
    var $author$project$Utils$Calculations$calculateTruckRate = F2(function(truckCapacity, roundTripTime) {
        var tripsPerHour = 60.0 / roundTripTime;
        var theoreticalRate = tripsPerHour * truckCapacity;
        return theoreticalRate * $author$project$Utils$Calculations$truckEfficiencyFactor;
    });
    var $elm$core$Basics$min = F2(function(x, y) {
        return _Utils_cmp(x, y) < 0 ? x : y;
    });
    var $author$project$Utils$Calculations$calculateTimeline = F6(function(excavatorCapacity, excavatorCycle, truckCapacity, truckRoundTrip, pondVolume, workHoursPerDay) {
        if (pondVolume <= 0) return $elm$core$Result$Err($author$project$Utils$Calculations$InvalidConfiguration('Pond volume must be positive'));
        else {
            if (workHoursPerDay <= 0) return $elm$core$Result$Err($author$project$Utils$Calculations$InvalidConfiguration('Work hours per day must be positive'));
            else {
                var haulingRate = A2($author$project$Utils$Calculations$calculateTruckRate, truckCapacity, truckRoundTrip);
                var excavationRate = A2($author$project$Utils$Calculations$calculateExcavatorRate, excavatorCapacity, excavatorCycle);
                var effectiveRate = A2($elm$core$Basics$min, excavationRate, haulingRate);
                var totalHours = pondVolume / effectiveRate;
                var timelineInDays = $elm$core$Basics$ceiling(totalHours / workHoursPerDay);
                var bottleneck = $elm$core$Basics$abs(excavationRate - haulingRate) < 5.0 ? $author$project$Utils$Calculations$Balanced : _Utils_cmp(excavationRate, haulingRate) < 0 ? $author$project$Utils$Calculations$ExcavationBottleneck : $author$project$Utils$Calculations$HaulingBottleneck;
                var confidence = function() {
                    if (bottleneck.$ === 'Balanced') return $author$project$Utils$Calculations$High;
                    else return $elm$core$Basics$abs(excavationRate - haulingRate) > 20.0 ? $author$project$Utils$Calculations$Low : $author$project$Utils$Calculations$Medium;
                }();
                var warnings = function() {
                    switch(bottleneck.$){
                        case 'ExcavationBottleneck':
                            return _List_fromArray([
                                'Excavation is the limiting factor - consider additional excavators'
                            ]);
                        case 'HaulingBottleneck':
                            return _List_fromArray([
                ...
                var assumptions = _List_fromArray([
                    'Excavator efficiency: ' + ($elm$core$String$fromFloat($author$project$Utils$Calculations$excavatorEfficiencyFactor * 100) + '%'),
                    'Truck efficiency: ' + ($elm$core$String$fromFloat($author$project$Utils$Calculations$truckEfficiencyFactor * 100) + '%'),
    ...
    var $author$project$Main$parseFormData = function(formData) {
        var maybeFloats = {
            excavatorCapacity: $elm$core$String$toFloat(formData.excavatorCapacity),
            excavatorCycleTime: $elm$core$String$toFloat(formData.excavatorCycleTime),
            pondDepth: $elm$core$String$toFloat(formData.pondDepth),
            pondLength: $elm$core$String$toFloat(formData.pondLength),
            pondWidth: $elm$core$String$toFloat(formData.pondWidth),
            truckCapacity: $elm$core$String$toFloat(formData.truckCapacity),
            truckRoundTripTime: $elm$core$String$toFloat(formData.truckRoundTripTime),
            workHoursPerDay: $elm$core$String$toFloat(formData.workHoursPerDay)
        };
        var _v0 = _Utils_Tuple3(maybeFloats.excavatorCapacity, maybeFloats.excavatorCycleTime, maybeFloats.truckCapacity);
        if (_v0.a.$ === 'Just' && _v0.b.$ === 'Just' && _v0.c.$ === 'Just') {
            var excavatorCapacity = _v0.a.a;
            var excavatorCycleTime = _v0.b.a;
            var truckCapacity = _v0.c.a;
            var _v1 = _Utils_Tuple3(maybeFloats.truckRoundTripTime, maybeFloats.workHoursPerDay, maybeFloats.pondLength);
            if (_v1.a.$ === 'Just' && _v1.b.$ === 'Just' && _v1.c.$ === 'Just') {
                var truckRoundTripTime = _v1.a.a;
                var workHoursPerDay = _v1.b.a;
                var pondLength = _v1.c.a;
                var _v2 = _Utils_Tuple2(maybeFloats.pondWidth, maybeFloats.pondDepth);
                if (_v2.a.$ === 'Just' && _v2.b.$ === 'Just') {
                    var pondWidth = _v2.a.a;
                    var pondDepth = _v2.b.a;
                    return $elm$core$Result$Ok({
                        excavatorCapacity: excavatorCapacity,
                ...
                } else return $elm$core$Result$Err('Invalid pond dimensions format');
            } else return $elm$core$Result$Err('Invalid equipment or work parameters format');
        } else return $elm$core$Result$Err('Invalid excavator or truck parameters format');
    };
    ...
    var $author$project$Types$Validation$RequiredField = function(a) {
        return {
            $: 'RequiredField',
            a: a
        };
    };
    var $author$project$Types$Validation$ValueTooHigh = F2(function(a, b) {
        return {
            $: 'ValueTooHigh',
            a: a,
            b: b
    ...
    var $author$project$Types$Validation$ValueTooLow = F2(function(a, b) {
        return {
            $: 'ValueTooLow',
            a: a,
            b: b
    ...
    var $author$project$Utils$Validation$validateRange = F3(function(fieldName, range, value) {
        return value <= 0 ? $elm$core$Result$Err($author$project$Types$Validation$RequiredField(fieldName)) : _Utils_cmp(value, range.min) < 0 ? $elm$core$Result$Err(A2($author$project$Types$Validation$ValueTooLow, value, range.min)) : _Utils_cmp(value, range.max) > 0 ? $elm$core$Result$Err(A2($author$project$Types$Validation$ValueTooHigh, value, range.max)) : $elm$core$Result$Ok(value);
    });
    var $author$project$Utils$Validation$validateCycleTime = F2(function(rules, cycleTime) {
        return A3($author$project$Utils$Validation$validateRange, 'Cycle Time', rules, cycleTime);
    });
    var $author$project$Utils$Validation$validateExcavatorCapacity = F2(function(rules, capacity) {
        return A3($author$project$Utils$Validation$validateRange, 'Excavator Capacity', rules, capacity);
    });
    var $author$project$Utils$Validation$validatePondDimensions = F2(function(rules, dimension) {
        return A3($author$project$Utils$Validation$validateRange, 'Pond Dimension', rules, dimension);
    });
    var $author$project$Utils$Validation$validateRoundTripTime = F2(function(rules, roundTripTime) {
        return A3($author$project$Utils$Validation$validateRange, 'Round Trip Time', rules, roundTripTime);
    });
    var $author$project$Utils$Validation$validateTruckCapacity = F2(function(rules, capacity) {
        return A3($author$project$Utils$Validation$validateRange, 'Truck Capacity', rules, capacity);
    });
    var $author$project$Utils$Validation$validateWorkHours = F2(function(rules, workHours) {
        return A3($author$project$Utils$Validation$validateRange, 'Work Hours', rules, workHours);
    });
    var $author$project$Utils$Validation$validateAllInputs = F2(function(rules, inputs) {
        return A2($elm$core$Result$map, function(_v7) {
            return inputs;
        }, A2($elm$core$Result$andThen, function(_v6) {
            return A2($author$project$Utils$Validation$validatePondDimensions, rules.pondDimensions, inputs.pondDepth);
        }, A2($elm$core$Result$andThen, function(_v5) {
            return A2($author$project$Utils$Validation$validatePondDimensions, rules.pondDimensions, inputs.pondWidth);
        }, A2($elm$core$Result$andThen, function(_v4) {
            return A2($author$project$Utils$Validation$validatePondDimensions, rules.pondDimensions, inputs.pondLength);
        }, A2($elm$core$Result$andThen, function(_v3) {
            return A2($author$project$Utils$Validation$validateWorkHours, rules.workHours, inputs.workHoursPerDay);
        }, A2($elm$core$Result$andThen, function(_v2) {
            return A2($author$project$Utils$Validation$validateRoundTripTime, rules.roundTripTime, inputs.truckRoundTripTime);
        }, A2($elm$core$Result$andThen, function(_v1) {
            return A2($author$project$Utils$Validation$validateTruckCapacity, rules.truckCapacity, inputs.truckCapacity);
        }, A2($elm$core$Result$andThen, function(_v0) {
            return A2($author$project$Utils$Validation$validateCycleTime, rules.cycleTime, inputs.excavatorCycleTime);
        }, A2($author$project$Utils$Validation$validateExcavatorCapacity, rules.excavatorCapacity, inputs.excavatorCapacity)))))))));
    });
    var $author$project$Main$calculateAndUpdate = function(model) {
        var _v0 = _Utils_Tuple2(model.formData, model.config);
        if (_v0.a.$ === 'Just' && _v0.b.$ === 'Just') {
            var formData = _v0.a.a;
            var config = _v0.b.a;
            var _v1 = $author$project$Main$parseFormData(formData);
            if (_v1.$ === 'Ok') {
                var inputs = _v1.a;
                var _v2 = A2($author$project$Utils$Validation$validateAllInputs, config.validation, inputs);
                if (_v2.$ === 'Ok') {
                    var validInputs = _v2.a;
                    var pondVolume = A3($author$project$Main$calculatePondVolume, validInputs.pondLength, validInputs.pondWidth, validInputs.pondDepth);
                    var performanceCmd = A2($elm$core$Task$perform, $author$project$Types$Messages$PerformanceTracked, $elm$core$Task$succeed(50.0));
                    var calculationResult = A6($author$project$Utils$Calculations$calculateTimeline, validInputs.excavatorCapacity, validInputs.excavatorCycleTime, validInputs.truckCapacity, validInputs.truckRoundTripTime, pondVolume, validInputs.workHoursPerDay);
                    if (calculationResult.$ === 'Ok') {
                        var result = calculationResult.a;
                        return _Utils_Tuple2(_Utils_update(model, {
                            calculationInProgress: false,
                            calculationResult: $elm$core$Maybe$Just(result),
                            lastValidResult: $elm$core$Maybe$Just(result)
                        }), performanceCmd);
    ...
    var $author$project$Utils$Config$fallbackDefaults = {
        excavator: {
            bucketCapacity: 2.5,
            cycleTime: 2.0,
    ...
    var $author$project$Utils$Config$fallbackValidationRules = {
        cycleTime: {
            max: 10.0,
            min: 0.5
        },
    ...
    var $author$project$Utils$Config$fallbackConfig = {
        defaults: $author$project$Utils$Config$fallbackDefaults,
        validation: $author$project$Utils$Config$fallbackValidationRules,
        version: '1.0.0'
    };
    var $author$project$Types$DeviceType$Mobile = {
        $: 'Mobile'
    };
    var $author$project$Types$DeviceType$Tablet = {
        $: 'Tablet'
    };
    var $author$project$Types$DeviceType$fromWindowSize = function(_v0) {
        var width = _v0.width;
        return width < 768 ? $author$project$Types$DeviceType$Mobile : width <= 1024 ? $author$project$Types$DeviceType$Tablet : $author$project$Types$DeviceType$Desktop;
    };
    var $author$project$Components$ProjectForm$initFormData = function(defaults) {
        return {
            errors: _List_Nil,
            excavatorCapacity: $elm$core$String$fromFloat(defaults.excavator.bucketCapacity),
            excavatorCycleTime: $elm$core$String$fromFloat(defaults.excavator.cycleTime),
            pondDepth: $elm$core$String$fromFloat(defaults.project.pondDepth),
            pondLength: $elm$core$String$fromFloat(defaults.project.pondLength),
            pondWidth: $elm$core$String$fromFloat(defaults.project.pondWidth),
            truckCapacity: $elm$core$String$fromFloat(defaults.truck.capacity),
            truckRoundTripTime: $elm$core$String$fromFloat(defaults.truck.roundTripTime),
            workHoursPerDay: $elm$core$String$fromFloat(defaults.project.workHoursPerDay)
        };
    };
    var $author$project$Utils$Performance$recordCalculationTime = F2(function(timeMs, metrics) {
        var newMax = A2($elm$core$Basics$max, metrics.maxTime, timeMs);
        var newCount = metrics.calculationCount + 1;
        var newAverage = !metrics.calculationCount ? timeMs : metrics.averageTime * 0.8 + timeMs * 0.2;
        return _Utils_update(metrics, {
    ...
    var $author$project$Components$ProjectForm$updateFormData = F2(function(msg, formData) {
        switch(msg.$){
            case 'UpdateExcavatorCapacity':
                var value = msg.a;
                return _Utils_update(formData, {
                    excavatorCapacity: value
                });
            case 'UpdateExcavatorCycleTime':
                var value = msg.a;
                return _Utils_update(formData, {
                    excavatorCycleTime: value
                });
            case 'UpdateTruckCapacity':
                var value = msg.a;
                return _Utils_update(formData, {
                    truckCapacity: value
                });
            case 'UpdateTruckRoundTripTime':
                var value = msg.a;
                return _Utils_update(formData, {
                    truckRoundTripTime: value
                });
            ...
            case 'UpdatePondLength':
                var value = msg.a;
                return _Utils_update(formData, {
                    pondLength: value
                });
            case 'UpdatePondWidth':
                var value = msg.a;
                return _Utils_update(formData, {
                    pondWidth: value
                });
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        update: while(true)switch(msg.$){
            ...
            case 'ConfigLoaded':
                ...
                var config = function() {
                    if (result.$ === 'Ok') {
                        var loadedConfig = result.a;
                        return loadedConfig;
                    } else return $author$project$Utils$Config$fallbackConfig;
                }();
                var newFormData = $author$project$Components$ProjectForm$initFormData(config.defaults);
                var modelWithData = _Utils_update(model, {
                    config: $elm$core$Maybe$Just(config),
                    formData: $elm$core$Maybe$Just(newFormData)
                });
                var $temp$msg = $author$project$Types$Messages$CalculateTimeline, $temp$model = modelWithData;
                msg = $temp$msg;
                model = $temp$model;
                continue update;
            case 'FormUpdated':
                var formMsg = msg.a;
                var _v2 = model.formData;
                if (_v2.$ === 'Just') {
                    var formData = _v2.a;
                    var updatedFormData = A2($author$project$Components$ProjectForm$updateFormData, formMsg, formData);
                    var newModel = _Utils_update(model, {
                        formData: $elm$core$Maybe$Just(updatedFormData)
                    });
                    var $temp$msg = $author$project$Types$Messages$CalculateTimeline, $temp$model = newModel;
                    msg = $temp$msg;
                    model = $temp$model;
                    continue update;
                } else return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
            case 'ExcavatorFieldChanged':
                var field = msg.a;
                var value = msg.b;
                var _v3 = model.formData;
                if (_v3.$ === 'Just') {
                    var formData = _v3.a;
                    var updatedFormData = function() {
                        if (field.$ === 'BucketCapacity') return _Utils_update(formData, {
                            excavatorCapacity: value
                        });
                        else return _Utils_update(formData, {
                            excavatorCycleTime: value
                        });
                    }();
                    var newModel = _Utils_update(model, {
            ...
            case 'TruckFieldChanged':
                var field = msg.a;
                var value = msg.b;
                var _v5 = model.formData;
                if (_v5.$ === 'Just') {
                    var formData = _v5.a;
                    var updatedFormData = function() {
                        if (field.$ === 'TruckCapacity') return _Utils_update(formData, {
                            truckCapacity: value
                        });
                        else return _Utils_update(formData, {
                            truckRoundTripTime: value
            ...
            case 'PondFieldChanged':
                var field = msg.a;
                var value = msg.b;
                var _v7 = model.formData;
                if (_v7.$ === 'Just') {
                    var formData = _v7.a;
                    var updatedFormData = function() {
                        switch(field.$){
            ...
            case 'ProjectFieldChanged':
                var field = msg.a;
                var value = msg.b;
                var _v9 = model.formData;
                if (_v9.$ === 'Just') {
                    var formData = _v9.a;
                    var updatedFormData = _Utils_update(formData, {
                        workHoursPerDay: value
                    });
                    var newModel = _Utils_update(model, {
                        calculationInProgress: true,
            ...
            case 'CalculateTimeline':
                return $author$project$Main$calculateAndUpdate(model);
            case 'CalculateTimelineDebounced':
                return $author$project$Main$calculateAndUpdate(model);
            case 'CalculationCompleted':
                var result = msg.a;
                if (result.$ === 'Ok') {
                    var resultString = result.a;
                    return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                } else {
            ...
            case 'PerformanceTracked':
                var timeMs = msg.a;
                var updatedMetrics = A2($author$project$Utils$Performance$recordCalculationTime, timeMs, model.performanceMetrics);
                return _Utils_Tuple2(_Utils_update(model, {
            ...
            case 'DeviceDetected':
                var result = msg.a;
                if (result.$ === 'Ok') {
                    var windowSize = result.a;
                    var deviceType = $author$project$Types$DeviceType$fromWindowSize(windowSize);
                    return _Utils_Tuple2(_Utils_update(model, {
            ...
            default:
                var width = msg.a;
                var height = msg.b;
                var deviceType = $author$project$Types$DeviceType$fromWindowSize({
                    height: height,
                    width: width
                });
                return _Utils_Tuple2(_Utils_update(model, {
    ...
    var $author$project$Types$Messages$ExcavatorFieldChanged = F2(function(a, b) {
        return {
            $: 'ExcavatorFieldChanged',
            a: a,
            b: b
        };
    });
    var $author$project$Types$Messages$PondFieldChanged = F2(function(a, b) {
        return {
            $: 'PondFieldChanged',
            a: a,
            b: b
    ...
    var $author$project$Types$Messages$ProjectFieldChanged = F2(function(a, b) {
        return {
            $: 'ProjectFieldChanged',
            a: a,
            b: b
    ...
    var $author$project$Types$Messages$TruckFieldChanged = F2(function(a, b) {
        return {
            $: 'TruckFieldChanged',
            a: a,
            b: b
    ...
    var $author$project$Types$Fields$BucketCapacity = {
        $: 'BucketCapacity'
    };
    var $author$project$Types$Fields$CycleTime = {
        $: 'CycleTime'
    };
    var $author$project$Types$Fields$PondDepth = {
        $: 'PondDepth'
    };
    var $author$project$Types$Fields$PondLength = {
        $: 'PondLength'
    };
    var $author$project$Types$Fields$PondWidth = {
        $: 'PondWidth'
    };
    var $author$project$Types$Fields$RoundTripTime = {
        $: 'RoundTripTime'
    };
    var $author$project$Types$Fields$TruckCapacity = {
        $: 'TruckCapacity'
    };
    var $author$project$Types$Fields$WorkHours = {
        $: 'WorkHours'
    };
    ...
    var $author$project$Components$ProjectForm$getFieldError = F2(function(fieldName, errors) {
        return A2($elm$core$Maybe$map, $elm$core$Tuple$second, $elm$core$List$head(A2($elm$core$List$filter, function(_v0) {
            var field = _v0.a;
            return _Utils_eq(field, fieldName);
        }, errors)));
    });
    var $author$project$Styles$Components$getFormClasses = function(deviceType) {
        var baseClasses = 'bg-white rounded-lg shadow-md';
        switch(deviceType.$){
            case 'Mobile':
                return baseClasses + ' p-4 space-y-4';
            case 'Tablet':
                return baseClasses + ' p-6 space-y-6';
            default:
                return baseClasses + ' p-8 space-y-6';
        }
    };
    var $author$project$Styles$Responsive$getGridClasses = function(deviceType) {
        switch(deviceType.$){
            case 'Mobile':
    ...
    var $author$project$Styles$Components$getValidationMessageClasses = function(deviceType) {
        var baseClasses = 'text-red-500 font-medium';
        switch(deviceType.$){
            case 'Mobile':
                return baseClasses + ' text-sm mt-2 p-2 bg-red-50 rounded border border-red-200';
            case 'Tablet':
                return baseClasses + ' text-sm mt-1';
            default:
                return baseClasses + ' text-xs mt-1';
        }
    };
    var $author$project$Styles$Theme$getInputClasses = function(deviceType) {
        var baseClasses = 'shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline';
        switch(deviceType.$){
            case 'Mobile':
                return baseClasses + ' py-3 px-4 text-lg min-h-11';
            case 'Tablet':
                return baseClasses + ' py-3 px-3 text-base min-h-11';
            default:
                return baseClasses + ' py-2 px-3 text-sm';
        }
    };
    var $author$project$Components$ProjectForm$inputClasses = F2(function(deviceType, error) {
        var baseClasses = $author$project$Styles$Theme$getInputClasses(deviceType);
        if (error.$ === 'Just') return baseClasses + ' border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500';
        else return baseClasses + ' border-gray-300 placeholder-gray-400 focus:border-indigo-500 focus:ring-indigo-500';
    });
    var $elm$html$Html$label = _VirtualDom_node('label');
    var $elm$html$Html$Attributes$placeholder = $elm$html$Html$Attributes$stringProperty('placeholder');
    var $author$project$Components$ProjectForm$inputField = F2(function(deviceType, config) {
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$input, _List_fromArray([
                ...
                $elm$html$Html$Attributes$class(A2($author$project$Components$ProjectForm$inputClasses, deviceType, config.error))
            ]), _List_Nil),
            function() {
                var _v0 = config.error;
                if (_v0.$ === 'Just') {
                    var errorMsg = _v0.a;
                    return A2($elm$html$Html$span, _List_fromArray([
                        $elm$html$Html$Attributes$class($author$project$Styles$Components$getValidationMessageClasses(deviceType))
                    ]), _List_fromArray([
                        $elm$html$Html$text(errorMsg)
                    ]));
                } else return A2($elm$html$Html$span, _List_fromArray([
                    $elm$html$Html$Attributes$class('text-sm text-gray-500')
                ]), _List_Nil);
            }()
        ]));
    });
    var $author$project$Components$ProjectForm$view = F6(function(deviceType, formData, excavatorMsg, truckMsg, pondMsg, projectMsg) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class($author$project$Styles$Components$getFormClasses(deviceType))
        ]), _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md')
            ]), _List_fromArray([
                A2($elm$html$Html$div, _List_fromArray([
                    ...
                    A2($elm$html$Html$div, _List_fromArray([
                        ...
                        A2($elm$html$Html$span, _List_fromArray([
                            $elm$html$Html$Attributes$class('text-blue-400')
                        ]), _List_fromArray([
                    ...
                    A2($elm$html$Html$div, _List_fromArray([
                        ...
                        $elm$html$Html$text('Default values for common equipment are pre-loaded. Adjust any values to match your specific project requirements.')
                    ]))
                ]))
            ])),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class($author$project$Styles$Responsive$getGridClasses(deviceType))
            ]), _List_fromArray([
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('space-y-4')
                ]), _List_fromArray([
                    A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('text-lg font-semibold text-gray-800 mb-4')
                    ]), _List_fromArray([
                        $elm$html$Html$text('Equipment Specifications')
                    ])),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'excavatorCapacity', formData.errors),
                        id: 'excavator-capacity',
                        label: 'Excavator Bucket Capacity (cubic yards)',
                        onInput: excavatorMsg($author$project$Types$Fields$BucketCapacity),
                        placeholder: '',
                        value: formData.excavatorCapacity
                    }),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'excavatorCycleTime', formData.errors),
                        id: 'excavator-cycle',
                        label: 'Excavator Cycle Time (minutes)',
                        onInput: excavatorMsg($author$project$Types$Fields$CycleTime),
                        placeholder: '',
                        value: formData.excavatorCycleTime
                    }),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'truckCapacity', formData.errors),
                        id: 'truck-capacity',
                        label: 'Truck Capacity (cubic yards)',
                        onInput: truckMsg($author$project$Types$Fields$TruckCapacity),
                        placeholder: '',
                        value: formData.truckCapacity
                    }),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'truckRoundTripTime', formData.errors),
                        id: 'truck-roundtrip',
                        label: 'Truck Round-trip Time (minutes)',
                        onInput: truckMsg($author$project$Types$Fields$RoundTripTime),
                        placeholder: '',
                ...
                A2($elm$html$Html$div, _List_fromArray([
                    ...
                    A2($elm$html$Html$div, _List_fromArray([
                        ...
                        $elm$html$Html$text('Project Parameters')
                    ])),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'workHoursPerDay', formData.errors),
                        id: 'work-hours',
                        label: 'Work Hours per Day',
                        onInput: projectMsg($author$project$Types$Fields$WorkHours),
                        placeholder: '',
                        value: formData.workHoursPerDay
                    }),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'pondLength', formData.errors),
                        id: 'pond-length',
                        label: 'Pond Length (feet)',
                        onInput: pondMsg($author$project$Types$Fields$PondLength),
                        placeholder: '',
                        value: formData.pondLength
                    }),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'pondWidth', formData.errors),
                        id: 'pond-width',
                        label: 'Pond Width (feet)',
                        onInput: pondMsg($author$project$Types$Fields$PondWidth),
                        placeholder: '',
                        value: formData.pondWidth
                    }),
                    A2($author$project$Components$ProjectForm$inputField, deviceType, {
                        error: A2($author$project$Components$ProjectForm$getFieldError, 'pondDepth', formData.errors),
                        id: 'pond-depth',
                        label: 'Pond Depth (feet)',
                        onInput: pondMsg($author$project$Types$Fields$PondDepth),
                        placeholder: '',
    ...
    var $author$project$Components$ResultsPanel$assumptionsSection = function(assumptions) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('bg-blue-50 p-4 rounded-lg')
        ]), _List_fromArray([
            A2($elm$html$Html$h4, _List_fromArray([
                $elm$html$Html$Attributes$class('text-sm font-semibold text-blue-800 mb-2')
            ]), _List_fromArray([
                $elm$html$Html$text('Calculation Assumptions')
            ])),
            A2($elm$html$Html$ul, _List_fromArray([
                $elm$html$Html$Attributes$class('text-xs text-blue-700 space-y-1')
            ]), A2($elm$core$List$map, function(assumption) {
                return A2($elm$html$Html$li, _List_fromArray([
                    ...
                    $elm$html$Html$text(assumption)
                ]));
            }, assumptions))
        ]));
    };
    var $author$project$Components$ResultsPanel$bottleneckIndicator = function(bottleneck) {
        var _v0 = function() {
            switch(bottleneck.$){
                case 'ExcavationBottleneck':
                    return _Utils_Tuple2('Excavation Limited', 'text-amber-600');
                case 'HaulingBottleneck':
                    return _Utils_Tuple2('Hauling Limited', 'text-amber-600');
                default:
                    return _Utils_Tuple2('Well Balanced', 'text-green-600');
            }
        }();
        var label = _v0.a;
        var color = _v0.b;
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$span, _List_fromArray([
                ...
                $elm$html$Html$text('Bottleneck')
            ])),
            A2($elm$html$Html$span, _List_fromArray([
                $elm$html$Html$Attributes$class('text-sm font-medium ' + color)
            ]), _List_fromArray([
                $elm$html$Html$text(label)
            ]))
        ]));
    };
    var $author$project$Components$ResultsPanel$confidenceIndicator = function(confidence) {
        var _v0 = function() {
            switch(confidence.$){
                case 'High':
                    return _Utils_Tuple3('High', 'text-green-600', 'Equipment well balanced');
                case 'Medium':
                    return _Utils_Tuple3('Medium', 'text-amber-600', 'Minor equipment imbalance');
                default:
                    return _Utils_Tuple3('Low', 'text-red-600', 'Significant equipment imbalance');
            }
        }();
        var label = _v0.a;
        var color = _v0.b;
    ...
    var $author$project$Components$ResultsPanel$formatHours = function(hours) {
        return hours < 10 ? $elm$core$String$fromFloat($elm$core$Basics$round(hours * 10) / 10) : $elm$core$String$fromInt($elm$core$Basics$round(hours));
    };
    var $author$project$Styles$Components$getResultsPanelClasses = function(deviceType) {
        var baseClasses = 'bg-blue-50 border border-blue-200 rounded-lg';
        switch(deviceType.$){
            case 'Mobile':
                return baseClasses + ' p-4 space-y-3';
            case 'Tablet':
                return baseClasses + ' p-6 space-y-4';
            default:
                return baseClasses + ' p-8 space-y-6';
        }
    };
    var $elm$html$Html$h3 = _VirtualDom_node('h3');
    var $author$project$Components$ResultsPanel$formatRate = function(rate) {
        return $elm$core$String$fromFloat($elm$core$Basics$round(rate * 10) / 10);
    };
    var $author$project$Components$ResultsPanel$productivityRow = F3(function(label, rate, units) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('flex justify-between items-center')
        ]), _List_fromArray([
            A2($elm$html$Html$span, _List_fromArray([
            ...
            A2($elm$html$Html$span, _List_fromArray([
                ...
                $elm$html$Html$text($author$project$Components$ResultsPanel$formatRate(rate) + (' ' + units))
            ]))
        ]));
    });
    var $author$project$Components$ResultsPanel$warningsSection = function(warnings) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('bg-amber-50 p-4 rounded-lg')
        ]), _List_fromArray([
            A2($elm$html$Html$h4, _List_fromArray([
                $elm$html$Html$Attributes$class('text-sm font-semibold text-amber-800 mb-2')
            ]), _List_fromArray([
                $elm$html$Html$text('Recommendations')
            ])),
            A2($elm$html$Html$ul, _List_fromArray([
                $elm$html$Html$Attributes$class('text-xs text-amber-700 space-y-1')
            ]), A2($elm$core$List$map, function(warning) {
                return A2($elm$html$Html$li, _List_fromArray([
                    $elm$html$Html$Attributes$class('flex items-start')
                ]), _List_fromArray([
                    A2($elm$html$Html$span, _List_fromArray([
    ...
    var $author$project$Components$ResultsPanel$view = F3(function(deviceType, result, isStale) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class($author$project$Styles$Components$getResultsPanelClasses(deviceType))
        ]), _List_fromArray([
            isStale ? A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md')
            ]), _List_fromArray([
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('flex items-center')
                ]), _List_fromArray([
                    A2($elm$html$Html$span, _List_fromArray([
                        $elm$html$Html$Attributes$class('text-yellow-400 mr-2')
                    ]), _List_fromArray([
                        $elm$html$Html$text("\u26A0\uFE0F")
                    ])),
                    A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('text-sm text-yellow-800')
                    ]), _List_fromArray([
                        $elm$html$Html$text('Showing last valid calculation while current inputs have validation errors')
                    ]))
                ]))
            ])) : $elm$html$Html$text(''),
            A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($elm$html$Html$h3, _List_fromArray([
                    ...
                    $elm$html$Html$text('Project Timeline')
                ])),
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('text-6xl font-bold text-indigo-600 mb-2')
                ]), _List_fromArray([
                    $elm$html$Html$text($elm$core$String$fromInt(result.timelineInDays))
                ])),
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('text-xl text-gray-600')
                ]), _List_fromArray([
                    $elm$html$Html$text(result.timelineInDays === 1 ? 'day' : 'days')
                ])),
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('text-sm text-gray-500 mt-2')
                ]), _List_fromArray([
                    $elm$html$Html$text('(' + ($author$project$Components$ResultsPanel$formatHours(result.totalHours) + ' total hours)'))
                ]))
            ])),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('grid grid-cols-1 md:grid-cols-2 gap-6 mb-6')
            ]), _List_fromArray([
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('bg-gray-50 p-4 rounded-lg')
                ]), _List_fromArray([
                    A2($elm$html$Html$h4, _List_fromArray([
                        $elm$html$Html$Attributes$class('text-lg font-semibold text-gray-800 mb-3')
                    ]), _List_fromArray([
                        $elm$html$Html$text('Equipment Productivity')
                    ])),
                    A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('space-y-2')
                    ]), _List_fromArray([
                        A3($author$project$Components$ResultsPanel$productivityRow, 'Excavation Rate', result.excavationRate, 'cy/hour'),
                        A3($author$project$Components$ResultsPanel$productivityRow, 'Hauling Rate', result.haulingRate, 'cy/hour'),
                        $author$project$Components$ResultsPanel$bottleneckIndicator(result.bottleneck)
                    ]))
                ])),
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('bg-gray-50 p-4 rounded-lg')
                    ...
                    A2($elm$html$Html$h4, _List_fromArray([
                        ...
                        $elm$html$Html$text('Project Analysis')
                    ])),
                    A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('space-y-2')
                    ]), _List_fromArray([
                        $author$project$Components$ResultsPanel$confidenceIndicator(result.confidence),
                        A2($elm$html$Html$div, _List_fromArray([
                            $elm$html$Html$Attributes$class('text-sm text-gray-600')
                        ]), _List_fromArray([
                            $elm$html$Html$text('Rounded up to whole days for scheduling')
                        ]))
                    ]))
                ]))
            ])),
            A2($elm$html$Html$div, _List_fromArray([
                ...
                !$elm$core$List$isEmpty(result.assumptions) ? $author$project$Components$ResultsPanel$assumptionsSection(result.assumptions) : $elm$html$Html$text(''),
                !$elm$core$List$isEmpty(result.warnings) ? $author$project$Components$ResultsPanel$warningsSection(result.warnings) : $elm$html$Html$text('')
            ]))
        ]));
    });
    var $author$project$Main$view = function(model) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('min-h-screen bg-gray-100 py-8')
        ]), _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($elm$html$Html$div, _List_fromArray([
                    ...
                    A2($elm$html$Html$h1, _List_fromArray([
                        $elm$html$Html$Attributes$class('text-4xl font-bold text-gray-900 mb-2')
                    ]), _List_fromArray([
                        $elm$html$Html$text('Pond Digging Calculator')
                    ])),
                    A2($elm$html$Html$h2, _List_fromArray([
                        $elm$html$Html$Attributes$class('text-xl text-gray-600')
                    ]), _List_fromArray([
                        $elm$html$Html$text('Professional Timeline Estimation Tool')
                    ]))
                ])),
                function() {
                    var _v0 = _Utils_Tuple2(model.formData, model.config);
                    if (_v0.b.$ === 'Just') {
                        if (_v0.a.$ === 'Just') {
                            ...
                            return A2($elm$html$Html$div, _List_fromArray([
                                ...
                                A6($author$project$Components$ProjectForm$view, model.deviceType, formData, $author$project$Types$Messages$ExcavatorFieldChanged, $author$project$Types$Messages$TruckFieldChanged, $author$project$Types$Messages$PondFieldChanged, $author$project$Types$Messages$ProjectFieldChanged),
                                function() {
                                    var _v1 = model.calculationResult;
                                    if (_v1.$ === 'Just') {
                                        var result = _v1.a;
                                        var isStale = function() {
                                            var _v2 = _Utils_Tuple2(model.lastValidResult, model.calculationResult);
                                            if (_v2.a.$ === 'Just' && _v2.b.$ === 'Just') {
                                                var lastValid = _v2.a.a;
                                                var current = _v2.b.a;
                                                return _Utils_eq(lastValid, current) && !model.calculationInProgress;
                                            } else return false;
                                        }();
                                        return A3($author$project$Components$ResultsPanel$view, model.deviceType, result, isStale);
                                    } else return A2($elm$html$Html$div, _List_fromArray([
                                        $elm$html$Html$Attributes$class('text-center text-gray-500')
                                    ]), _List_fromArray([
                                        $elm$html$Html$text('Enter project parameters above to see timeline calculation')
                                    ]));
                                }()
                            ]));
                        } else {
                            ...
                            return A2($elm$html$Html$div, _List_fromArray([
                                ...
                                $elm$html$Html$text('Initializing form...')
                            ]));
                        }
                    } else {
                        var _v4 = _v0.b;
                        return A2($elm$html$Html$div, _List_fromArray([
                            ...
                            $elm$html$Html$text('Loading configuration...')
                        ]));
                    }
                }()
            ]))
    ...
    _Platform_export({
        'Main': {
            'init': $author$project$Main$main($elm$json$Json$Decode$succeed(_Utils_Tuple0))({
                ...
                "types": {
                    "message": "Types.Messages.Msg",
                    "aliases": {
                        "Utils.Config.Config": {
                            "args": [],
                            "type": "{ version : String.String, defaults : Utils.Config.Defaults, validation : Utils.Config.ValidationRules }"
                        },
                        "Types.Equipment.CubicYards": {
                            "args": [],
                            "type": "Basics.Float"
                        },
                        "Utils.Config.Defaults": {
                            "args": [],
                            "type": "{ excavator : Utils.Config.ExcavatorDefaults, truck : Utils.Config.TruckDefaults, project : Utils.Config.ProjectDefaults }"
                        },
                        "Types.Equipment.Equipment": {
                            "args": [],
                            "type": "{ id : Types.Equipment.EquipmentId, equipmentType : Types.Equipment.EquipmentType, name : String.String, bucketCapacity : Types.Equipment.CubicYards, cycleTime : Types.Equipment.Minutes, isActive : Basics.Bool }"
                        },
                        "Types.Equipment.EquipmentId": {
                            "args": [],
                            "type": "String.String"
                        },
                        "Utils.Config.ExcavatorDefaults": {
                            "args": [],
                            "type": "{ bucketCapacity : Basics.Float, cycleTime : Basics.Float, name : String.String }"
                        },
                        "Types.Equipment.Minutes": {
                            "args": [],
                            "type": "Basics.Float"
                        },
                        "Utils.Config.ProjectDefaults": {
                            "args": [],
                            "type": "{ workHoursPerDay : Basics.Float, pondLength : Basics.Float, pondWidth : Basics.Float, pondDepth : Basics.Float }"
                        },
                        "Utils.Config.TruckDefaults": {
                            "args": [],
                            "type": "{ capacity : Basics.Float, roundTripTime : Basics.Float, name : String.String }"
                        },
                        "Utils.Config.ValidationRange": {
                            "args": [],
                            "type": "{ min : Basics.Float, max : Basics.Float }"
                        },
                        "Utils.Config.ValidationRules": {
                            "args": [],
                            "type": "{ excavatorCapacity : Utils.Config.ValidationRange, cycleTime : Utils.Config.ValidationRange, truckCapacity : Utils.Config.ValidationRange, roundTripTime : Utils.Config.ValidationRange, workHours : Utils.Config.ValidationRange, pondDimensions : Utils.Config.ValidationRange }"
                        }
                    },
                    "unions": {
                        "Types.Messages.Msg": {
                            ...
                            "tags": {
                                "NoOp": [],
                                "ConfigLoaded": [
                                    "Result.Result Types.Validation.ValidationError Utils.Config.Config"
                                ],
                                "EquipmentAdded": [
                                    "Types.Equipment.Equipment"
                                ],
                                ...
                                "FormUpdated": [
                                    "Components.ProjectForm.FormMsg"
                                ],
                                "ExcavatorFieldChanged": [
                                    "Types.Fields.ExcavatorField",
                                    "String.String"
                                ],
                                "TruckFieldChanged": [
                                    "Types.Fields.TruckField",
                                    "String.String"
                                ],
                                "PondFieldChanged": [
                                    "Types.Fields.PondField",
                                    "String.String"
                                ],
                                "ProjectFieldChanged": [
                                    "Types.Fields.ProjectField",
                                    "String.String"
                                ],
                                "CalculateTimeline": [],
                                "CalculateTimelineDebounced": [
                                    "Basics.Float"
                                ],
                                ...
                                "DeviceDetected": [
                                    "Result.Result Browser.Dom.Error { width : Basics.Int, height : Basics.Int }"
                                ],
                                "WindowResized": [
                                    "Basics.Int",
                                    "Basics.Int"
                        ...
                        "Components.ProjectForm.FormMsg": {
                            "args": [],
                            "tags": {
                                "UpdateExcavatorCapacity": [
                                    "String.String"
                                ],
                                "UpdateExcavatorCycleTime": [
                                    "String.String"
                                ],
                                "UpdateTruckCapacity": [
                                    "String.String"
                                ],
                                "UpdateTruckRoundTripTime": [
                                    "String.String"
                                ],
                                "UpdateWorkHours": [
                                    "String.String"
...
//# sourceMappingURL=public.daa5264e.js.map
