            ...
            [ test "Add Excavator button shows on Desktop" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewExcavatorFleet Desktop excavators 2
                    in
                    html
                        |> Query.fromHtml
            ...
            , test "Add Truck button shows on Tablet" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewTruckFleet Tablet trucks 2
                    in
                    html
                        |> Query.fromHtml
            ...
            , test "Add buttons hidden on Mobile" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewExcavatorFleet Mobile excavators 2
                    in
                    html
                        |> Query.fromHtml
            ...
            [ test "Multiple excavators display with numbering" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewExcavatorFleet Desktop excavators 4
                    in
                    html
                        |> Query.fromHtml
                        |> Expect.all
            ...
            , test "Multiple trucks display with individual input fields" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewTruckFleet Desktop trucks 3
                    in
                    html
                        |> Query.fromHtml
                        |> Expect.all
            ...
            [ test "Remove buttons show when multiple excavators exist" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewExcavatorFleet Desktop excavators 3
                    in
                    html
                        |> Query.fromHtml
            ...
            , test "Remove buttons hidden when only one truck exists" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewTruckFleet Desktop trucks 2
                    in
                    html
                        |> Query.fromHtml
            ...
            , test "Remove buttons hidden on mobile even with multiple items" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewExcavatorFleet Mobile excavators 4
                    in
                    html
                        |> Query.fromHtml
                        |> Query.findAll [ Selector.containing [ Selector.text "Remove" ] ]
            ...
            , test "Fleet limits are respected for add buttons" <|
                \_ ->
                    let
                        ...
                        html =
                            EquipmentList.viewExcavatorFleet Desktop excavators 11
                    in
                    html
                        |> Query.fromHtml
                        |> Query.findAll [ Selector.containing [ Selector.text "Add Excavator" ] ]
            ...
            , test "Device-specific padding and sizing applied" <|
                \_ ->
                    let
                        ...
                        tabletHtml =
                            EquipmentList.viewExcavatorFleet Tablet excavators 2
