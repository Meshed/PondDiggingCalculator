        ...
        [ describe "Sub-100ms Performance Requirements"
            [ test "should_calculate_excavator_rate_quickly" <|
                \_ ->
                    ...
                    let
                        rate =
                            Calculations.calculateExcavatorRate 2.5 1.5
                    in
            ...
            , test "should_calculate_truck_rate_quickly" <|
                \_ ->
                    let
                        rate =
                            Calculations.calculateTruckRate 15.0 10.0
                    in
                    Expect.greaterThan 0 rate
            , test "should_calculate_complete_timeline_quickly" <|
                \_ ->
                    let
                        result =
                            Calculations.calculateTimeline 2.5 1.5 15.0 10.0 1000.0 8.0
                    in
                    case result of
                        Ok timeline ->
        ...
        , describe "Decimal Precision Maintenance"
            ...
            , test "should_handle_precision_with_small_values" <|
                \_ ->
                    let
                        result =
                            Calculations.calculateTimeline 0.1 0.5 1.0 2.0 10.0 1.0
                    in
                    case result of
                        Ok timeline ->
                            Expect.all
            ...
            , test "should_handle_precision_with_large_values" <|
                \_ ->
                    let
                        result =
                            Calculations.calculateTimeline 10.0 5.0 50.0 20.0 100000.0 12.0
                    in
                    case result of
                        Ok timeline ->
                            Expect.all
